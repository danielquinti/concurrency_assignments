...
void *swap(void *ptr)
{
    ...
    while(args->iterations--) {
        ...
        pthread_mutex_lock(args->mutex); // Prevent other threads from modifying the array
        ...
        pthread_mutex_unlock(args->mutex); // Allow the rest of the threads to modify the array
        if(args->delay) usleep(args->delay);
